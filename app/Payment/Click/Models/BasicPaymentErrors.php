...
/**
 * @name \App\Payment\Click\Models\BasicPaymentErrors class, this class can help you for checking the prepare and complete errors
 *
 * @example
 *      $payments = new Payments();
 *      $response = $payments->request_check($request);
 */
class BasicPaymentErrors
{
    /** @var $provider : array */
    protected $provider = [];

    /**
     * @name \App\Payment\Click\Models\BasicPaymentErrors::request_check
