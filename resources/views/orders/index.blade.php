            ...
            <div class="row">
                <div class="col-6 col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="period_from" class="form-control datepicker-here" value="{{ $filter['period_from']->format('d.m.Y') }}">
                    </div>
                </div>
                <div class="col-6 col-md-4">
                    <div class="form-group">
                        <label for="period_to">{{ __('Period to') }}</label>
                        <input type="text" name="period_to" class="form-control datepicker-here" value="{{ $filter['period_to']->format('d.m.Y') }}">
                    </div>
                </div>
            </div>
            <div class="row">
