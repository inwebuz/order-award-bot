...
use App\Payment\Click\Models\Model;
use App\Payment\Click\Utils\Security;
use App\Payment\Click\Utils\Helper;
use App\Payment\Click\Utils\Configs;
use App\Payment\Click\Requests\Request;
use App\Payment\Click\Exceptions\ClickException;
use App\Payment\Click\models\PaymentsStatus;
use App\Payment\Click\models\BasePayments;
...
class Payments extends BasePayments
{
    ...
    /** @var $model : \App\Payment\Click\Models\Model object, it used for connecting to database and perform same processes over the database */
    protected $model = null;

    /** @var $helper : \App\Payment\Click\Utils\Helper object, included same helpful methods */
    protected $helper = null;

    /** @var $request : \App\Payment\Click\Request\Request object */
    ...
    public function __construct($params)
    {
        ...
        if ($params == null) {
            $params = [
                'db' => $this->configs->get_database_configs(),
            ];
        }
